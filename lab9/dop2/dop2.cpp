...
void better_student()
{
	...
	cout << "ФИО лучшего студента :" << better->fname << " " << better->sname << " " << better->thname << endl;
	cout << "<------------------------------------------------>" << endl;
}
void max_min_year()
{
...
void middle_groups()
{
	...
	for (int i = 0; i < count1; i++)
	{
		...
		cout << "ФИО : " << host5->fname << " " << host5->sname << " " << host5->thname << endl;
		cout << "Год рождения : " << host5->year << " Курс : " << host5->course << " Группа : " << host5->group << endl;
		cout << "Оценки : " << host5->marks[0] << " " << host5->marks[1] << " " << host5->marks[2] << " " << host5->marks[3] << " " << host5->marks[4] << endl;
		host5 = host5->next;
	}
	cout << "---------------------" << endl;*/
	item* best = host;
