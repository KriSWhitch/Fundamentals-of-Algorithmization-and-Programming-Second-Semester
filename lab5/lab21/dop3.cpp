...
//	cout << " 4 - Сумма положительных элементов, кратных 5-ти" << endl;
//	cout << " 5 - Выход" << endl;
//}
//
////------------------------ Нахождение суммы положительных элементов, кратных 5-ти -----------------
//int SumIntMod5Positive(int our_number, list* p)
//{
//	int sum = 0;
...
//		{
//			cout << "Наше положительное число, кратное 5-ти: " << our_number << endl;
//			sum = sum + our_number;
//		}
//	}
//	if (sum == 0)
//	{
//		cout << "Положительных элементов нет или же нет элементов, кратных 5-ти\n";
//	}
//	cout << "Сумма положительных элементов, кратных 5-ти: " << sum << endl;
//	return sum;
//}